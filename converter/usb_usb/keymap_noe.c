...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
  ...
  [SAFE]=KEYMAP_ALL(
		    ...
		    GRV, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, JYEN,FN22,     INS, HOME,PGUP,    NLCK,PSLS,PAST,PMNS,    STOP,AGIN,
		    TRNS, Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,   LBRC,RBRC,     FN2,     DEL, END, PGDN,    P7,  P8,  P9,  PPLS,    MENU,UNDO,
		    CAPS,A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,      FN2, ENT,                        P4,  P5,  P6,  PCMM,    SLCT,COPY,
